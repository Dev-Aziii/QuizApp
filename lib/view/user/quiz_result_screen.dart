...
class _QuizResultScreenState extends State<QuizResultScreen> {
  ...
  IconData _getMyPerformanceIcon(double score) {
                ...
                children: [
                  ...
                  ...widget.quiz.questions.asMap().entries.map((entry) {
                    ...
                    final selectedIndexes =
                        widget.selectedAnswers[index] ?? <int>{};

                    final correctSet = question.correctOptionIndexes.toSet();
